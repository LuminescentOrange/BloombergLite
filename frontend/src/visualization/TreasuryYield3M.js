...
const TreasuryYield3M = () => {
  ...
  let getEarning = async () => {
    let response = await fetch(`/lookup/daily_3month_treasury_yield/`)
    let data = await response.json()
    setEarning(data)
  }

  let getEarning1 = async () => {
    let response1 = await fetch(`/lookup/weekly_3month_treasury_yield/`)
    let data1 = await response1.json()
    setEarning1(data1)
  }

  let getEarning2 = async () => {
    let response2 = await fetch(`/lookup/monthly_3month_treasury_yield/`)
  ...
  return (
    ...
    export default TreasuryYield3M;